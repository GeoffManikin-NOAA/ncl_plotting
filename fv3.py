...
#for j in range(1):
   ...
   for ax in axes:
      ...
      if k == 0:
         model_str = 'FV3'
         try:
             fil = DATA_DIR+'/fv3.'+cycle[0:8]+'/hiresw.t'+ \
                   cycle[8:10]+'z.fv3_5km.f'+str(fhrs[j]).zfill(2)+'.conus.grib2'
      ...
      elif str.upper(model_str) == 'NAM3' or str.upper(model_str) == 'FV3':
         HLwindow = 300
         if domain in large_domains:
            skip = 50
         elif domain in subregional_domains:
