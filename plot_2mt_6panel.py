...
#for j in range(1):
   ...
   for ax in axes:
      ...
      m = Basemap(llcrnrlon=llcrnrlon,llcrnrlat=llcrnrlat,urcrnrlon=urcrnrlon,urcrnrlat=urcrnrlat,\
                  ...
                  lat_1=32.,lat_2=46.,lon_0=-96.,area_thresh=1000.,ax=ax)
      ...
      # Obs panel - URMA for 2-m T
         ...
         try:
             ...
             fil = DATA_DIR+'/urma.'+valid[0:8]+'/'+str.lower(anl_str)+'2p5.t'+ \
                   valid[8:10]+'z.2dvaranl_ndfd.grb2_wexp'
             grbs = pygrib.open(fil)

      # Obs panel - URMA for 2-m Dew Pt 
      elif k == 5 and field[0:2] == 'd2':
         print('urma section')
         model_str = 'URMA Analysis'
         anl_str = 'URMA'
         try:
...
#         clevs = np.arange(-16,132,4)
      ...
      # Dew Pt 
         ...
         d2  = grbs.select(stepType='instant',name='2 metre dewpoint temperature')[0].values*9/5 - 459.67

         clevs = np.arange(-10,84,2)
         tlevs = [str(clev) for clev in clevs]
