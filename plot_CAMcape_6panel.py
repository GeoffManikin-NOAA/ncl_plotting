...
machine = 'WCOSS2'
if machine == 'WCOSS2':
    DIR = '/lfs/h2/emc'+hostname[0]+'p2/ptmp/'+os.environ['USER']+'/rap_hrrr_retros'
    DATA_DIR = os.path.join('/lfs/h2/emc/vpppgb/noscrub/geoffrey.manikin/',case)
    GRAPHX_DIR = os.path.join('/lfs/h2/emc/ptmp/geoffrey.manikin/'+case+'graphx')
...
if cycle == '2022042812':
   fhrs = np.arange(30,40,3)
elif cycle == '2022042800':
   fhrs = np.arange(42,49,3)
elif cycle == '2022042900':
   fhrs = np.arange(18,28,3)
elif cycle == '2022042912':
   fhrs = np.arange(6,16,3)
elif cycle == '2022050400':
   fhrs = np.arange(15,25,3)
elif cycle == '2022050312':
   fhrs = np.arange(27,37,3)
elif cycle == '2022050300':
   fhrs = np.arange(45,49,3)
elif cycle == '2021121012':
   fhrs = np.arange(0,13,6)
...
#for j in range(1):
   ...
   for ax in axes:
      ...
      m = Basemap(llcrnrlon=llcrnrlon,llcrnrlat=llcrnrlat,urcrnrlon=urcrnrlon,urcrnrlat=urcrnrlat,\
                  ...
                  lat_1=32.,lat_2=46.,lon_0=-98.,area_thresh=1000.,ax=ax)
      ...
      # Obs panel - MRMS for REFC
         ...
         fil = DATA_DIR+'/mrms/MergedReflectivityQCComposite_00.50_'+valid[0:8]+'-'+valid[8:10]+'0000.nc'
      ...
      # Obs panel - RAP for CAPE
         ...
         try:
             ...
             fil = DATA_DIR+'/'+str.lower(anl_str)+'.'+valid[0:8]+'/'+str.lower(anl_str)+'.t'+ \
      ...
      # CAPE
         ...
         titlestr = date_str.strftime('%HZ %m/%d ')+field_title+' Forecasts and Analysis '+valid_list[j].strftime('Valid at %HZ %d %b %Y')+' (F'+str(fhrs[j]
).zfill(2)+')'
